...
3. Como dijimos en [el post anterior](), una vista debe de retornar un objeto HttpResponse, que a groso modo es la template asociada a la vista. Gracias a la variable <i>template_name</i> podemos especificar que template retorna la vista genérica.
